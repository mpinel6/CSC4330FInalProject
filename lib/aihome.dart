  ...
  void _playSelectedCards() {
    setState(() {
      ...
      if (_isPlayer1Turn) {
        ...
        _lastPlayedCards = _player2Cards
                    ...
                    TextButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const matthomepage()),
                        );
                      },
                      child: const Text(
                        'Go Home',
                                  ...
                                  showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        ...
                                        content: Text(
                                          isPlayer1
                                              ? 'Player 1 loses a token!'
                                              : 'Player 2 loses a token!',
                                          style: const TextStyle(
                                            color: Colors.brown,
                                          ),
                                        ),
                                          ...
                                          TextButton(
                                            onPressed: () {
                                              Navigator.of(context)
                                                  .pop(); // Close the Bad Luck dialog
                                              Navigator.of(context)
                                                  .pop(); // Close the Test Your Luck dialog
                                              setState(() {
                                                // Reset game state
                                                _hasDealt = false;
                                                _hasSecondPlayer = false;
