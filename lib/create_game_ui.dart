  ...
  void _startGame() {
    ...
    try {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Game starting...')));
    } catch (e) {
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      color: _statusMessage!.contains('connected')
                          ...
                          : null,
                      fontWeight: _statusMessage!.contains('connected')
                          ? FontWeight.bold
                          : null,
                      fontSize: 20,
                    ),
                  ...
                  children: [
                        ...
                        return Transform.scale(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              minimumSize:
                                  const Size(180, 48), // Make button wider
                            ),
                            child: const Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    fontWeight:
                                        FontWeight.bold, // Added missing comma
                    ...
                    TextButton(
                      onPressed: () async {
                        ...
                        final success =
                            await _multiplayerService.resetConnection();
                        ...
                        if (success) {
                          ...
                          setState(() {
                            _playerConnected = false;
                            _statusMessage =
                                'Game canceled. Network reset failed.';
                          });
                        }
                      },
