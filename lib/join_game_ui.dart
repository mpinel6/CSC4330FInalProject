...
class _JoinGamePageState extends State<JoinGamePage> {
  ...
  void initState() {
    ...
    _multiplayerService.gameDataStream.listen((data) {
  ...
  void _scanForGames() async {
    ...
    try {
      ...
      final Map<String, String> hostsWithNames =
          await _networkDiscovery.getHostsWithNames(8888);
                ...
                Center(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          isConnected ? Colors.green[600] : Colors.brown[600],
                        ...
                        : isConnected
                            ? Row(
                                ...
                                children: [
                                  ...
                                  const Text('Success! Waiting for host...',
                                      style: TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.bold,
                                      )),
...
// Set up listeners to close dialog on game events
    _multiplayerService.gameDataStream
        .where((data) =>
                            ...
                            style: TextStyle(
                              ...
                              shadows: [
                                ...
                                Shadow(
                                    offset: Offset(2, 2), color: Colors.black),
                                Shadow(
                                    offset: Offset(0, -2), color: Colors.black),
                                Shadow(
                                    offset: Offset(0, 2), color: Colors.black),
                                Shadow(
                                    offset: Offset(-2, 0), color: Colors.black),
                                Shadow(
                                    offset: Offset(2, 0), color: Colors.black),
                                Shadow(
                                    offset: Offset(-1, -1),
              ...
              child: _availableHosts.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final deviceName =
                            _availableHosts[host] ?? 'Unknown Device';
